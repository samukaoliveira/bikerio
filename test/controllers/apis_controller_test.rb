...
class ApisControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create api" do
    assert_difference("Api.count") do
      post apis_url, params: { api: { endereco: @api.endereco, latitude: @api.latitude, longitude: @api.longitude } }
    end
  ...
  test "should update api" do
    patch api_url(@api), params: { api: { endereco: @api.endereco, latitude: @api.latitude, longitude: @api.longitude } }
